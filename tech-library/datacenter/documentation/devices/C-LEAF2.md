...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.122/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_C-LEAF1_Ethernet5 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet6 | MLAG_C-LEAF1_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet7 | SERVER_HostN_Ethernet2 | *access | *10 | *- | *- | 7 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_C-SPINE1_Ethernet2 | - | 192.168.1.5/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_C-SPINE2_Ethernet2 | - | 192.168.1.7/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_C-SPINE1_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_C-SPINE2_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description MLAG_C-LEAF1_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_C-LEAF1_Ethernet6
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7
   description SERVER_HostN_Ethernet2
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel7 | HostN | access | 10 | - | - | - | - | 7 | - |
| Port-Channel1000 | MLAG_C-LEAF1_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_C-LEAF1_Port-Channel1000
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.3.2/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.3.1/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 1.1.3.2 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.3.2:10010 | 10010:10010 | - | - | learned |
