...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet7 | HostI | access | 60 | - | - | - |
| Ethernet8 | SERVER_HostJ_Ethernet1 | *access | *10 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_B-SPINE1_Ethernet3 | - | 192.168.1.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_B-SPINE2_Ethernet3 | - | 192.168.1.19/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_B-SPINE3_Ethernet3 | - | 192.168.1.21/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_B-SPINE4_Ethernet3 | - | 192.168.1.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet8
   description SERVER_HostJ_Ethernet1
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.2.3/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.2.3/32 |
| Loopback101 | DIAG_VRF_Prod | Prod | 10.101.102.3/32 |
| Loopback102 | DIAG_VRF_Dev | Dev | 10.102.102.3/32 |
...
| --- | ------------------- | ------------ |
| Dev | 1.1.2.3:50002 | connected |
| Prod | 1.1.2.3:50001 | connected |
...
ip address virtual source-nat vrf Prod address 10.101.102.3
```
