...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.132/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_D-LEAF3_Ethernet5 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet6 | MLAG_D-LEAF3_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet7 | D5 | access | 90 | - | - | - |
| Ethernet8 | SERVER_D4_Ethernet2 | *access | *10 | *- | *- | 8 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_D-SPINE1_Ethernet4 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet2 | P2P_D-SPINE2_Ethernet4 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet3 | P2P_D-SPINE3_Ethernet4 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet4 | P2P_D-SPINE4_Ethernet4 | - | - | default | 9214 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_D-SPINE1_Ethernet4
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet2
   description P2P_D-SPINE2_Ethernet4
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet3
   description P2P_D-SPINE3_Ethernet4
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet4
   description P2P_D-SPINE4_Ethernet4
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet5
   description MLAG_D-LEAF3_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_D-LEAF3_Ethernet6
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7
...
!
interface Ethernet8
   description SERVER_D4_Ethernet2
   no shutdown
...
| Port-Channel1000 | MLAG_D-LEAF3_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_D-LEAF3_Port-Channel1000
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.4.4/32 |
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:d:1::4/128 |
...
interface Loopback0
   ...
   ipv6 address 2001:db8:d:1::4/128
!
interface Loopback1
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.4.4:10010 | 10010:10010 | - | - | learned |
| 50 | 1.1.4.4:10050 | 10050:10050 | - | - | learned |
| 90 | 1.1.4.4:10090 | 10090:10090 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Dev | 1.1.4.4:50002 | connected |
| Prod | 1.1.4.4:50001 | connected |
...
router bgp 65434
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description D-LEAF3
