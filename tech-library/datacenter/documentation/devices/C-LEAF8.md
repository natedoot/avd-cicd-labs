...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.128/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_C-LEAF7_Ethernet5 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet6 | MLAG_C-LEAF7_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_C-SPINE1_Ethernet8 | - | 192.168.1.29/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_C-SPINE2_Ethernet8 | - | 192.168.1.31/31 | default | 9214 | False | - | - |
| Ethernet7 | P2P_BB1_Ethernet6 | - | 172.16.3.4/31 | default | 9214 | False | - | - |
| Ethernet8 | P2P_BB2_Ethernet6 | - | 172.16.3.6/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_C-SPINE1_Ethernet8
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_C-SPINE2_Ethernet8
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description MLAG_C-LEAF7_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_C-LEAF7_Ethernet6
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7
   description P2P_BB1_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_C-LEAF7_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_C-LEAF7_Port-Channel1000
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.3.8/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.3.7/32 <br> 10.3.3.255/32 secondary |
| Loopback101 | DIAG_VRF_Prod | Prod | 10.101.103.8/32 |
| Loopback102 | DIAG_VRF_Dev | Dev | 10.102.103.8/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf Prod
   ip address 10.101.103.8/32
!
interface Loopback102
   description DIAG_VRF_Dev
   no shutdown
   vrf Dev
   ip address 10.102.103.8/32
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 1.1.3.8 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> Ethernet7 <br> Ethernet8 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| 172.16.3.5 | Inherited from peer group IPv4-REMOTE-UNDERLAY-PEERS | default | - | - | - | - | - | - | - | - | - |
| 172.16.3.7 | Inherited from peer group IPv4-REMOTE-UNDERLAY-PEERS | default | - | - | - | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.3.8:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 20 | 1.1.3.8:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
| 30 | 1.1.3.8:10030 | 10030:10030<br>remote 10030:10030 | - | - | learned |
| 40 | 1.1.3.8:10040 | 10040:10040<br>remote 10040:10040 | - | - | learned |
| 50 | 1.1.3.8:10050 | 10050:10050<br>remote 10050:10050 | - | - | learned |
| 60 | 1.1.3.8:10060 | 10060:10060<br>remote 10060:10060 | - | - | learned |
| 70 | 1.1.3.8:10070 | 10070:10070<br>remote 10070:10070 | - | - | learned |
| 80 | 1.1.3.8:10080 | 10080:10080<br>remote 10080:10080 | - | - | learned |
| 100 | 1.1.3.8:10100 | 10100:10100<br>remote 10100:10100 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Dev | 1.1.3.8:50002 | connected |
| Prod | 1.1.3.8:50001 | connected |
...
router bgp 65378
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description C-LEAF7
   ...
   neighbor 172.16.3.5 peer group IPv4-REMOTE-UNDERLAY-PEERS
   neighbor 172.16.3.5 description BB1_UNDERLAY
   neighbor 172.16.3.7 peer group IPv4-REMOTE-UNDERLAY-PEERS
   neighbor 172.16.3.7 description BB2_UNDERLAY
   !
   vlan 10
      rd 1.1.3.8:10010
      rd evpn domain remote 1.1.3.8:10010
   ...
   vlan 20
      rd 1.1.3.8:10020
      rd evpn domain remote 1.1.3.8:10020
   ...
   vlan 30
      rd 1.1.3.8:10030
      rd evpn domain remote 1.1.3.8:10030
   ...
   vlan 40
      rd 1.1.3.8:10040
      rd evpn domain remote 1.1.3.8:10040
   ...
   vlan 50
      rd 1.1.3.8:10050
      rd evpn domain remote 1.1.3.8:10050
   ...
   vlan 60
      rd 1.1.3.8:10060
      rd evpn domain remote 1.1.3.8:10060
   ...
   vlan 70
      rd 1.1.3.8:10070
      rd evpn domain remote 1.1.3.8:10070
   ...
   vlan 80
      rd 1.1.3.8:10080
      rd evpn domain remote 1.1.3.8:10080
   ...
   vlan 100
      rd 1.1.3.8:10100
      rd evpn domain remote 1.1.3.8:10100
   ...
   vrf Dev
      ...
      neighbor 192.0.0.0 description C-LEAF7_Vlan3002
   ...
   vrf Prod
      ...
      router-id 1.1.3.8
      neighbor 192.0.0.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.0 description C-LEAF7_Vlan3001
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
```eos
!
ip address virtual source-nat vrf Dev address 10.102.103.8
ip address virtual source-nat vrf Prod address 10.101.103.8
```
