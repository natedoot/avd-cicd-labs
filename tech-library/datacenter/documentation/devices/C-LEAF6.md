...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.126/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_C-LEAF5_Ethernet5 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet6 | MLAG_C-LEAF5_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet7 | SERVER_HostR_Ethernet2 | *access | *20 | *- | *- | 7 |
| Ethernet8 | SERVER_HostS_Ethernet2 | *access | *60 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_C-SPINE1_Ethernet6 | - | 192.168.1.21/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_C-SPINE2_Ethernet6 | - | 192.168.1.23/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_C-SPINE1_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_C-SPINE2_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description MLAG_C-LEAF5_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_C-LEAF5_Ethernet6
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7
   description SERVER_HostR_Ethernet2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description SERVER_HostS_Ethernet2
   no shutdown
...
| Port-Channel1000 | MLAG_C-LEAF5_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_C-LEAF5_Port-Channel1000
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.3.6/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 1.1.3.6 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 1.1.3.6:10020 | 10020:10020 | - | - | learned |
| 60 | 1.1.3.6:10060 | 10060:10060 | - | - | learned |
