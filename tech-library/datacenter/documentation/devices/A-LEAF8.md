...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_A-SPINE1_Ethernet8 | - | 192.168.1.57/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_A-SPINE2_Ethernet8 | - | 192.168.1.59/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_A-SPINE3_Ethernet8 | - | 192.168.1.61/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_A-SPINE4_Ethernet8 | - | 192.168.1.63/31 | default | 9214 | False | - | - |
| Ethernet7 | P2P_BB1_Ethernet2 | - | 172.16.1.4/31 | default | 9214 | False | - | - |
| Ethernet8 | P2P_BB2_Ethernet2 | - | 172.16.1.6/31 | default | 9214 | False | - | - |
...
| 20 | 1.1.1.8:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
| 30 | 1.1.1.8:10030 | 10030:10030<br>remote 10030:10030 | - | - | learned |
| 40 | 1.1.1.8:10040 | 10040:10040<br>remote 10040:10040 | - | - | learned |
| 50 | 1.1.1.8:10050 | 10050:10050<br>remote 10050:10050 | - | - | learned |
| 60 | 1.1.1.8:10060 | 10060:10060<br>remote 10060:10060 | - | - | learned |
| 70 | 1.1.1.8:10070 | 10070:10070<br>remote 10070:10070 | - | - | learned |
| 80 | 1.1.1.8:10080 | 10080:10080<br>remote 10080:10080 | - | - | learned |
| 100 | 1.1.1.8:10100 | 10100:10100<br>remote 10100:10100 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Dev | 1.1.1.8:50002 | connected |
| Prod | 1.1.1.8:50001 | connected |
...
router bgp 65178
   ...
   vlan 20
      rd 1.1.1.8:10020
      rd evpn domain remote 1.1.1.8:10020
   ...
   vlan 30
      rd 1.1.1.8:10030
      rd evpn domain remote 1.1.1.8:10030
   ...
   vlan 40
      rd 1.1.1.8:10040
      rd evpn domain remote 1.1.1.8:10040
   ...
   vlan 60
      rd 1.1.1.8:10060
      rd evpn domain remote 1.1.1.8:10060
   ...
   vlan 80
      rd 1.1.1.8:10080
      rd evpn domain remote 1.1.1.8:10080
   ...
   vlan 100
      rd 1.1.1.8:10100
      rd evpn domain remote 1.1.1.8:10100
   ...
   vrf Dev
      ...
      router-id 1.1.1.8
      neighbor 192.0.0.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.0 description A-LEAF7_Vlan3002
   ...
   vrf Prod
      ...
      router-id 1.1.1.8
      neighbor 192.0.0.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.0 description A-LEAF7_Vlan3001
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
```eos
!
ip address virtual source-nat vrf Dev address 10.102.101.8
