...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.124/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_C-LEAF3_Ethernet5 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet6 | MLAG_C-LEAF3_Ethernet6 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet7 | HostQ | access | 50 | - | - | - |
| Ethernet8 | SERVER_HostP_Ethernet2 | *access | *60 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_C-SPINE1_Ethernet4 | - | 192.168.1.13/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_C-SPINE2_Ethernet4 | - | 192.168.1.15/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_C-SPINE1_Ethernet4
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_C-SPINE2_Ethernet4
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description MLAG_C-LEAF3_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_C-LEAF3_Ethernet6
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7
...
!
interface Ethernet8
   description SERVER_HostP_Ethernet2
   no shutdown
...
| Port-Channel1000 | MLAG_C-LEAF3_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_C-LEAF3_Port-Channel1000
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.3.4/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 1.1.3.4 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 1.1.3.4:10020 | 10020:10020 | - | - | learned |
| 50 | 1.1.3.4:10050 | 10050:10050 | - | - | learned |
| 60 | 1.1.3.4:10060 | 10060:10060 | - | - | learned |
