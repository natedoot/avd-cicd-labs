...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.114/24 | - |
...
| Ethernet8 | SERVER_HostJ_Ethernet2 | *access | *10 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_B-SPINE1_Ethernet4 | - | 192.168.1.25/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_B-SPINE2_Ethernet4 | - | 192.168.1.27/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_B-SPINE3_Ethernet4 | - | 192.168.1.29/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_B-SPINE4_Ethernet4 | - | 192.168.1.31/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel8 | HostJ | access | 10 | - | - | - | - | - | 0000:000b:0003:0004:0008 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel8 | 0000:000b:0003:0004:0008 | all-active | 00:03:00:04:00:08 |
...
interface Port-Channel8
   ...
   evpn ethernet-segment
      ...
      route-target import 00:03:00:04:00:08
   lacp system-id 0003.0004.0008
   spanning-tree portfast
   spanning-tree bpduguard enable
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.2.4/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.2.4/32 |
| Loopback101 | DIAG_VRF_Prod | Prod | 10.101.102.4/32 |
| Loopback102 | DIAG_VRF_Dev | Dev | 10.102.102.4/32 |
...
| Net-ID | 49.1111.0010.0100.2004.00 |
| Type | level-2 |
| Router-ID | 1.1.2.4 |
...
| --- | ------------------- | ------------ |
| Dev | 1.1.2.4:50002 | connected |
| Prod | 1.1.2.4:50001 | connected |
...
ip address virtual source-nat vrf Prod address 10.101.102.4
```
