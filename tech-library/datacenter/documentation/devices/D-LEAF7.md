...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.135/24 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_D-SPINE1_Ethernet7 | - | 192.168.1.49/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_D-SPINE2_Ethernet7 | - | 192.168.1.51/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_D-SPINE3_Ethernet7 | - | 192.168.1.53/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_D-SPINE4_Ethernet7 | - | 192.168.1.55/31 | default | 9214 | False | - | - |
| Ethernet7 | P2P_BB1_Ethernet7 | - | 172.16.4.0/31 | default | 9214 | False | - | - |
| Ethernet8 | P2P_BB2_Ethernet7 | - | 172.16.4.2/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_D-SPINE1_Ethernet7
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_D-SPINE2_Ethernet7
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet3
   description P2P_D-SPINE3_Ethernet7
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet4
   description P2P_D-SPINE4_Ethernet7
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet7
   description P2P_BB1_Ethernet7
   no shutdown
   mtu 9214
   no switchport
   ip address 172.16.4.0/31
!
interface Ethernet8
   description P2P_BB2_Ethernet7
   no shutdown
   mtu 9214
   no switchport
   ip address 172.16.4.2/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.4.7/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.4.7/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 1.1.4.7/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 2.2.4.7/32
```
...
| 172.16.4.1 | 65500 | default | - | Inherited from peer group LOCAL-UNDERLAY-PEERS | Inherited from peer group LOCAL-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.4.3 | 65500 | default | - | Inherited from peer group LOCAL-UNDERLAY-PEERS | Inherited from peer group LOCAL-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.48 | 65400 | default | - | Inherited from peer group LOCAL-UNDERLAY-PEERS | Inherited from peer group LOCAL-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.50 | 65400 | default | - | Inherited from peer group LOCAL-UNDERLAY-PEERS | Inherited from peer group LOCAL-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.52 | 65400 | default | - | Inherited from peer group LOCAL-UNDERLAY-PEERS | Inherited from peer group LOCAL-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.54 | 65400 | default | - | Inherited from peer group LOCAL-UNDERLAY-PEERS | Inherited from peer group LOCAL-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.4.7:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 50 | 1.1.4.7:10050 | 10050:10050<br>remote 10050:10050 | - | - | learned |
| 70 | 1.1.4.7:10070 | 10070:10070<br>remote 10070:10070 | - | - | learned |
| 90 | 1.1.4.7:10090 | 10090:10090<br>remote 10090:10090 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Dev | 1.1.4.7:50002 | connected |
| Prod | 1.1.4.7:50001 | connected |
...
router bgp 65478
   ...
   neighbor 172.16.4.1 peer group LOCAL-UNDERLAY-PEERS
   neighbor 172.16.4.1 remote-as 65500
   neighbor 172.16.4.1 description BB1
   neighbor 172.16.4.3 peer group LOCAL-UNDERLAY-PEERS
   neighbor 172.16.4.3 remote-as 65500
   neighbor 172.16.4.3 description BB2
   neighbor 192.168.1.48 peer group LOCAL-UNDERLAY-PEERS
   neighbor 192.168.1.48 remote-as 65400
   neighbor 192.168.1.48 description D-SPINE1_Ethernet7
   neighbor 192.168.1.50 peer group LOCAL-UNDERLAY-PEERS
   neighbor 192.168.1.50 remote-as 65400
   neighbor 192.168.1.50 description D-SPINE2_Ethernet7
   neighbor 192.168.1.52 peer group LOCAL-UNDERLAY-PEERS
   neighbor 192.168.1.52 remote-as 65400
   neighbor 192.168.1.52 description D-SPINE3_Ethernet7
   neighbor 192.168.1.54 peer group LOCAL-UNDERLAY-PEERS
   neighbor 192.168.1.54 remote-as 65400
   neighbor 192.168.1.54 description D-SPINE4_Ethernet7
   ...
   vlan 10
      rd 1.1.4.7:10010
      rd evpn domain remote 1.1.4.7:10010
   ...
   vlan 50
      rd 1.1.4.7:10050
      rd evpn domain remote 1.1.4.7:10050
   ...
   vlan 70
      rd 1.1.4.7:10070
      rd evpn domain remote 1.1.4.7:10070
   ...
   vlan 90
      rd 1.1.4.7:10090
      rd evpn domain remote 1.1.4.7:10090
