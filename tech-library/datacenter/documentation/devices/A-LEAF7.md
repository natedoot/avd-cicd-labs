...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_A-SPINE1_Ethernet7 | - | 192.168.1.49/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_A-SPINE2_Ethernet7 | - | 192.168.1.51/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_A-SPINE3_Ethernet7 | - | 192.168.1.53/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_A-SPINE4_Ethernet7 | - | 192.168.1.55/31 | default | 9214 | False | - | - |
| Ethernet7 | P2P_BB1_Ethernet1 | - | 172.16.1.0/31 | default | 9214 | False | - | - |
| Ethernet8 | P2P_BB2_Ethernet1 | - | 172.16.1.2/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.1.7/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.1.7/32 |
| Loopback101 | Per-VRF Unique Loopback | Prod | 10.101.101.7/32 |
| Loopback102 | Per-VRF Unique Loopback | Dev | 10.102.101.7/32 |
...
| 172.16.1.1 | 65500 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.1.3 | 65500 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 192.168.1.48 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.50 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.52 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.54 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 100 | 1.1.1.7:10100 | 10100:10100<br>remote 10100:10100 | - | - | learned |
...
router bgp 65178
   ...
   vlan 100
      rd 1.1.1.7:10100
      rd evpn domain remote 1.1.1.7:10100
   ...
   vrf Dev
      ...
      router-id 1.1.1.7
      neighbor 192.0.0.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.1 description A-LEAF8_Vlan3002
   ...
   vrf Prod
      ...
      router-id 1.1.1.7
      neighbor 192.0.0.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.1 description A-LEAF8_Vlan3001
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
