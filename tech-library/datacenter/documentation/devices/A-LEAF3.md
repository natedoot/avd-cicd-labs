...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.103/24 | - |
...
| Ethernet7 | HostC | access | 50 | - | - | - |
| Ethernet8 | SERVER_HostD_Ethernet1 | *access | *10 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_A-SPINE1_Ethernet3 | - | 192.168.1.17/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_A-SPINE2_Ethernet3 | - | 192.168.1.19/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_A-SPINE3_Ethernet3 | - | 192.168.1.21/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_A-SPINE4_Ethernet3 | - | 192.168.1.23/31 | default | 9214 | False | - | - |
...
!
interface Ethernet8
   description SERVER_HostD_Ethernet1
   no shutdown
...
| Loopback101 | DIAG_VRF_Prod | Prod | 10.101.101.3/32 |
| Loopback102 | DIAG_VRF_Dev | Dev | 10.102.101.3/32 |
...
| 192.168.1.16 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.18 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.20 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.22 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65134
   ...
   neighbor 192.168.1.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.16 remote-as 65100
   neighbor 192.168.1.16 description A-SPINE1_Ethernet3
   neighbor 192.168.1.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.18 remote-as 65100
   neighbor 192.168.1.18 description A-SPINE2_Ethernet3
   neighbor 192.168.1.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.20 remote-as 65100
   neighbor 192.168.1.20 description A-SPINE3_Ethernet3
   neighbor 192.168.1.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.22 remote-as 65100
   neighbor 192.168.1.22 description A-SPINE4_Ethernet3
   ...
   vrf Dev
      ...
      router-id 1.1.1.3
      neighbor 192.0.0.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.1 description A-LEAF4_Vlan3002
   ...
   vrf Prod
      ...
      router-id 1.1.1.3
      neighbor 192.0.0.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.1 description A-LEAF4_Vlan3001
      redistribute connected route-map RM-CONN-2-BGP-VRFS
      evpn multicast
```
...
```eos
!
ip address virtual source-nat vrf Dev address 10.102.101.3
