...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_A-LEAF1_Ethernet1 | - | 192.168.1.0/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_A-LEAF2_Ethernet1 | - | 192.168.1.8/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_A-LEAF3_Ethernet1 | - | 192.168.1.16/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_A-LEAF4_Ethernet1 | - | 192.168.1.24/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_A-LEAF5_Ethernet1 | - | 192.168.1.32/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_A-LEAF6_Ethernet1 | - | 192.168.1.40/31 | default | 9214 | False | - | - |
| Ethernet7 | P2P_A-LEAF7_Ethernet1 | - | 192.168.1.48/31 | default | 9214 | False | - | - |
| Ethernet8 | P2P_A-LEAF8_Ethernet1 | - | 192.168.1.56/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.1.201/32 |
...
| 192.168.1.1 | 65112 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.9 | 65112 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.17 | 65134 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.25 | 65134 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.33 | 65156 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.41 | 65156 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.49 | 65178 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.57 | 65178 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 192.168.1.1 description A-LEAF1_Ethernet1
   neighbor 192.168.1.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.9 remote-as 65112
   neighbor 192.168.1.9 description A-LEAF2_Ethernet1
   neighbor 192.168.1.17 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.17 remote-as 65134
   neighbor 192.168.1.17 description A-LEAF3_Ethernet1
   neighbor 192.168.1.25 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.25 remote-as 65134
   neighbor 192.168.1.25 description A-LEAF4_Ethernet1
   neighbor 192.168.1.33 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.33 remote-as 65156
   neighbor 192.168.1.33 description A-LEAF5_Ethernet1
   neighbor 192.168.1.41 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.41 remote-as 65156
   neighbor 192.168.1.41 description A-LEAF6_Ethernet1
   neighbor 192.168.1.49 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.49 remote-as 65178
   neighbor 192.168.1.49 description A-LEAF7_Ethernet1
   neighbor 192.168.1.57 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.57 remote-as 65178
   neighbor 192.168.1.57 description A-LEAF8_Ethernet1
