...
| Ethernet7 | SERVER_HostA_Ethernet1 | *access | *20 | *- | *- | 7 |
| Ethernet8 | SERVER_HostB_Ethernet1 | *access | *30 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_A-SPINE1_Ethernet1 | - | 192.168.1.1/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_A-SPINE2_Ethernet1 | - | 192.168.1.3/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_A-SPINE3_Ethernet1 | - | 192.168.1.5/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_A-SPINE4_Ethernet1 | - | 192.168.1.7/31 | default | 9214 | False | - | - |
...
!
interface Ethernet7
   description SERVER_HostA_Ethernet1
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description SERVER_HostB_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel7 | HostA | access | 20 | - | - | - | - | 7 | - |
| Port-Channel8 | HostB | access | 30 | - | - | - | - | 8 | - |
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.1.1/32 |
| Loopback101 | DIAG_VRF_Prod | Prod | 10.101.101.1/32 |
...
| 192.168.1.0 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.2 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.4 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.6 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65112
   ...
   vrf Prod
      ...
      router-id 1.1.1.1
      neighbor 192.0.0.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.0.0.1 description A-LEAF2_Vlan3001
