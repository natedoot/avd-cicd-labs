...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet7 | SERVER_HostG_Ethernet2 | *access | *20 | *- | *- | 7 |
| Ethernet8 | SERVER_HostH_Ethernet2 | *access | *40 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_B-SPINE1_Ethernet2 | - | 192.168.1.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_B-SPINE2_Ethernet2 | - | 192.168.1.11/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_B-SPINE3_Ethernet2 | - | 192.168.1.13/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_B-SPINE4_Ethernet2 | - | 192.168.1.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet7
   description SERVER_HostG_Ethernet2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description SERVER_HostH_Ethernet2
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.2.2/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2.2.2.2/32 |
| Loopback101 | DIAG_VRF_Prod | Prod | 10.101.102.2/32 |
...
| Net-ID | 49.1111.0010.0100.2002.00 |
| Type | level-2 |
| Router-ID | 1.1.2.2 |
...
```eos
!
ip address virtual source-nat vrf Prod address 10.101.102.2
```
