...
| Ethernet7 | SERVER_HostA_Ethernet2 | *access | *20 | *- | *- | 7 |
| Ethernet8 | SERVER_HostB_Ethernet2 | *access | *30 | *- | *- | 8 |
...
!
interface Ethernet7
   description SERVER_HostA_Ethernet2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description SERVER_HostB_Ethernet2
   no shutdown
...
| Loopback101 | DIAG_VRF_Prod | Prod | 10.101.101.2/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 1.1.1.2:10020 | 10020:10020 | - | - | learned |
...
| --- | ------------------- | ------------ | -------------- |
| Prod | 1.1.1.2:50001 | connected | IPv4: True<br>Transit: False |
