...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet7 | P2P_D-LEAF7_Ethernet3 | - | 192.168.1.52/31 | default | 9214 | False | - | - |
| Ethernet8 | P2P_D-LEAF8_Ethernet3 | - | 192.168.1.60/31 | default | 9214 | False | - | - |

##### IPv6

| Interface | Description | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_D-LEAF1_Ethernet3 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet2 | P2P_D-LEAF2_Ethernet3 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet3 | P2P_D-LEAF3_Ethernet3 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet4 | P2P_D-LEAF4_Ethernet3 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet5 | P2P_D-LEAF5_Ethernet3 | - | - | default | 9214 | False | - | - | - | - |
| Ethernet6 | P2P_D-LEAF6_Ethernet3 | - | - | default | 9214 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_D-LEAF1_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet2
   description P2P_D-LEAF2_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet3
   description P2P_D-LEAF3_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet4
   description P2P_D-LEAF4_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet5
   description P2P_D-LEAF5_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet6
   description P2P_D-LEAF6_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ipv6 enable
!
interface Ethernet7
   description P2P_D-LEAF7_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet8
   description P2P_D-LEAF8_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 1.1.4.203/32 |

##### IPv6

| Interface | Description | VRF | IPv6 Address |
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:d:1::cb/128 |
...
interface Loopback0
   ...
   no shutdown
   ip address 1.1.4.203/32
   ipv6 address 2001:db8:d:1::cb/128
```
